...
########
# TOO BIG FOR GITHUB TO RUN, BUT YOU CAN FEEL FREE TO DO SO.
# RUN PREPROCESS, THEN TWEAK MILTRAINN.N. TO YOUR LIKING
# FINALLY TEST MODEL WITH USEN.N.MODEL
########
...
# TO ONLY RUN IF YOU WANT PICKLE DATA
...
# create_test_data_pickle('testdata.manual.2009.06.14.csv')